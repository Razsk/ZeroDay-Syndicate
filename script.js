...
const REVENUE_MULTIPLIER = 50; // Multiplier for SaaS revenue, decoupled from OPEX
...
function gameTick() {
    ...
    gameState.saasCategories.forEach(cat => {
        ...
        const categoryTotalRevenue = totalEfficacy * REVENUE_MULTIPLIER * (market.tam / BASE_TAM);
